        ...
        <>
            ...
            <div className="custom-page">
                <div className="header">
                    ...
                    <img src="../../../public/Image ArticleFree1.png" alt="Centered" className="center-image" />
                </div>

                <div className="contentMagazine">
                    <div className="side-images">
                        <img src="../../../public/Image ArticleFree2.png" alt="Left 1" className="left-image1" />
                        <img src="../../../public/Image ArticleFree3.png" alt="Left 2" className="left-image2" />
                    </div>
                ...
                <img src="../../../public/Image ArticleFree4.png" alt="Full Width" className="full-width-image" />
                    ...
                    <div className="grid-container">
                        <div className="grid-item">
                            <div className="thumbnail-content">
                                <img src="../../../public/Image ArticleFree5.png" alt="Thumbnail 1" className="thumbnail" />
                        ...
                        <div className="grid-item">
                            <div className="thumbnail-content">
                                <img src="../../../public/Image ArticleFree6.jpeg" alt="Thumbnail 2" className="thumbnail" />
                                    <div className="thumbnail-text">
                        ...
                        <div className="grid-item">
                            <div className="thumbnail-content">
                                <img src="../../../public/Image ArticleFree5.png" alt="Thumbnail 3" className="thumbnail" />
                                    <div className="thumbnail-text">
                                        <h3>Rubrique 3</h3>
                        ...
                        <div className="grid-item">
                            <div className="thumbnail-content">
                                <img src="../../../public/Image ArticleFree6.jpeg" alt="Thumbnail 4" className="thumbnail" />
                                    <div className="thumbnail-text">
                                        <h3>Rubrique 4</h3>
